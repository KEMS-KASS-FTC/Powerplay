...
public class StrafingAutonPowerplay extends LinearOpMode {
    OpenCvCamera camera;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        });
        {
            ...
            if(currentDetections.size() != 0)
            {
                ...
                {
                    if(tag.id == R1 || tag.id == R2 || tag.id == R3 ||tag.id == L1 || tag.id == L2 || tag.id == L3)
                    {

                        if (tag.id == R1 || tag.id == R2 || tag.id == R3) {
                            side = 1;
                        } else {
                            side = -1;
                        }
