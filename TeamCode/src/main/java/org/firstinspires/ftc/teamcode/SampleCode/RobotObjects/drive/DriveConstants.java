...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1.01698342; // output (wheel) speed / input (motor) speed
    ...
    public static double MAX_ANG_VEL = 4.60555;
    public static double MAX_ANG_ACCEL = 3.6195116609176057;
